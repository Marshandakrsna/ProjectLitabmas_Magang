<%@ Page Title="" Language="C#" MasterPageFile="~/Homev3_vertical_menu.Master" AutoEventWireup="true" CodeBehind="AdminKelolaUser.aspx.cs" Inherits="silppm_v1e2.WebForm21" %>
...
<SelectedRowStyle CssClass="SelectedRowStyle"></SelectedRowStyle>
    ...
    <asp:Panel ID="panelUbah" runat="server">
        ...
        <br />
        <strong>
        <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="Ubah Role" />
        </strong>
    </asp:Panel>
</asp:Content>
