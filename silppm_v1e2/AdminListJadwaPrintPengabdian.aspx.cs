...
{
    public partial class WebForm99 : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName == "surat")
            {
                ...
                using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                {
                    ...
                    document.Add(new Paragraph("\n"));
                    document.Add(new Paragraph("\n"));
                    document.Add(new Paragraph("Nomor :" + tmp + "/LPPM-UAJY/" + DateTime.Now.ToString().Substring(0, 11) + ""));
                    ...
                    document.Add(new Paragraph("\n"));
                    document.Add(new Paragraph("\n"));
                    Paragraph p2 = new Paragraph("Yogyakarta, " + DateTime.Now.ToString().Substring(0, 11));
                    p2.Font.IsBold();
