...
namespace silppm_v1e2
{
    public partial class REVPenelitian : System.Web.UI.Page
    {
            ...
            if (Session["userdata"] != null)
                {
                    ...
                    propDS = prop.getAllDataProposalBy_IDProposal(tampungidProposal);
        ...
        {
            int tmp1= Convert.ToInt32(txtSkor1.SelectedValue) * 20;
            Label1.Text = tmp1.ToString();
            Label1n.Text = (tmp1 * 7.5).ToString();
            jumlah();
        }

        protected void txtSkor2_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp2 = Convert.ToInt32(txtSkor2.SelectedValue) * 10;
            Label2.Text = tmp2.ToString();
            Label2n.Text = (tmp2 * 37.5).ToString();
            jumlah();
        }
        protected void txtSkor3_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp3 = Convert.ToInt32(txtSkor3.SelectedValue) * 10;

            Label3.Text = tmp3.ToString();
            Label3n.Text = (tmp3 * 12.5).ToString();
            jumlah();
        }
        protected void txtSkor4_SelectedIndexChanged(object sender, EventArgs e)
        { 
     
            int tmp4 = Convert.ToInt32(txtSkor4.SelectedValue) * 10;
            Label4.Text = tmp4.ToString();
            Label4n.Text = (tmp4 * 7.5).ToString();
            jumlah();
        }
        protected void txtSkor5_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp5 = Convert.ToInt32(txtSkor5.SelectedValue) * 20;
            Label5.Text = tmp5.ToString();
            Label5n.Text = (tmp5 * 12.5).ToString();
            jumlah(); 
        }
        protected void txtSkor6_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp6 = Convert.ToInt32(txtSkor6.SelectedValue) * 10;
            Label6.Text = tmp6.ToString();
            Label6n.Text = (tmp6 * 12.5).ToString();
            jumlah();
        }
        protected void txtSkor7_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp7 = Convert.ToInt32(txtSkor7.SelectedValue) * 20;
            Label7.Text = tmp7.ToString();
            Label7n.Text = (tmp7 * 10).ToString();
            jumlah();
