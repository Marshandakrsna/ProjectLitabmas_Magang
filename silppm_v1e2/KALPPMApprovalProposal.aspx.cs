    ...
    public partial class WebForm55 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["userdata"] != null)
            {
                ...
                maxcountrev = rev.getMaxctRev(tmpid, tmprev);
                ...
                dana1 = double.Parse(dataset.Tables[0].Rows[0]["DANA_UAJY"].ToString());
                lblDanaUAJY.Text = string.Format("{0:##,###}", dana1);
                dana2 = double.Parse(dataset.Tables[0].Rows[0]["DANA_PRIBADI"].ToString());
                lblDanaPribadi.Text = string.Format("{0:##,###}", dana2);

                dataset.Clear();
                dsRev1.Clear();
                dsRev1 = rev.getDataReview(tmpid, tmprev, maxcountrev);
                db2 = double.Parse(dsRev1.Tables[0].Rows[0][19].ToString());
                    db1 = double.Parse(dsRev1.Tables[0].Rows[0][18].ToString());
                    lblDanaRekomen.Text = string.Format("{0:##,###}", db1);
                    lblDanaSetuju.Text =string.Format("{0:##,###}", db2);
        ...
        public void KirimEmailPustakawan()
        {
            ...
            if (email != "")
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert",
                          "alert('Gagal Mengirim Email! Periksa Email Pustakawan!');", true);
            }
        }
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            {
                //belom ditambahin LOG dr penelitian
                if (prop.addProposalLolos(tmpid, 0))
                {
                ...
                //toLabel = DateTime.ParseExact(String.Format("{0:dd/" + tmpmonth + "/yyyy}", akhir), "dd/MM/yyyy",null);
                ...
                using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
                {
                    ...
                    float[] widths = new float[] { 60f, 50f, 50f, 50f, 60f };
                    ...
                    + "<br/>Judul : " + judul
                    + "<br/> Berikut telah dilampirkan jadwal penelitian anda.  <br/> Selanjutnya silahkan datang ke LPPM untuk mencetak surat pengantar pencairan dana.<br/> Terimakasih.";
                        mail.Body = Body;
                        mail.IsBodyHtml = true;
        ...
        {
            Response.Redirect("KALPPMaddFeedbackPenelitian.aspx?id=" + tmpid);
        }
    }
}