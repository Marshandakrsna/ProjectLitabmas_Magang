<%@ Page Title="" Language="C#" MasterPageFile="~/Homev3_vertical_menu.Master" AutoEventWireup="true" CodeBehind="ProdiDIsplayHistoryPengabdian.aspx.cs" Inherits="silppm_v1e2.WebForm95" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:Label ID="Label1" runat="server" Text="History Pengabdian"></asp:Label>
