...
{
    public partial class adminREVPenelitian : System.Web.UI.Page
    {
        ...
        private string tampungstatus, tampungidProposal, namareviewer;
        private int flag;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["userdata"] != null)
            {
                ...
                string npp = Request.QueryString["npp"];
                txtNppReviewer.Text = npp;
                txtNppReviewer_TextChanged(sender, e);
            }
            else
            {
        ...
        protected void txtNppReviewer_TextChanged(object sender, EventArgs e)
        {
            tampungidProposal = Request.QueryString["id"];
            UserEntity ue = Session["userdata"] as UserEntity;

            namareviewer = ue.NAMA;
            propDS = prop.getAllDataProposal(txtNppReviewer.Text);
            if (propDS.Rows.Count > 0)
            {
                ...
                //lblFakDosen.Text = datauser.getFakultasByUsername(txtNppReviewer.Text);
                //lblProdDosen.Text = datauser.getjurusanByUsername(txtNppReviewer.Text);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            double.TryParse(Label1n.Text, out tmpSkor1);
            double.TryParse(Label2n.Text, out tmpSkor2);
            double.TryParse(Label3n.Text, out tmpSkor3);
            double.TryParse(Label4n.Text, out tmpSkor4);
            double.TryParse(Label5n.Text, out tmpSkor5);
            double.TryParse(Label6n.Text, out tmpSkor6);
            double.TryParse(Label7n.Text, out tmpSkor7);
            //int.TryParse(txtBiayaRekomen.Text, out rek);

            int ctrev = 0;
            try
            {
                ctrev = rev.getMaxctRev(hidden1.Value, txtNppReviewer.Text);
                ctrev += 1;
            }
            catch
            {
            ...
            //if (rek > 0)
            //{
            if (rev.addNilaiPenelitian(hidden1.Value, txtNppReviewer.Text, ctrev, tmpSkor1,
                tmpSkor2, tmpSkor3, tmpSkor4, tmpSkor5, tmpSkor6, tmpSkor7, txtSkor1.SelectedItem.ToString(), txtSkor2.SelectedItem.ToString(),
                txtSkor3.SelectedItem.ToString(), txtSkor4.SelectedItem.ToString(), txtSkor5.SelectedItem.ToString(), txtSkor6.SelectedItem.ToString(), txtSkor7.SelectedItem.ToString()))
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (Int32.Parse(jumlah) == 2)
                    {
                        ...
                        if (Int32.Parse(nilai) >= 550)
                        {
                            prop.UpdateStatusDiterima(hidden1.Value);
                            prop.addProposalLolos(hidden1.Value, 0);
        ...
        public void sendEmailDiterima()
        {
            ...
            string namaProdi = datauser.getNamaByNPP(txtNppReviewer.Text);
        ...
        protected void txtSkor1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            int tmp = Convert.ToInt32(txtSkor1.SelectedValue);
            Label1.Text = tmp.ToString();
            Label1n.Text = (tmp*7.5).ToString(); 
            jumlah();
        ...
        {
            int tmp = Convert.ToInt32(txtSkor2.SelectedValue);
            Label2.Text = tmp.ToString();
            Label2n.Text = (tmp * 37.5).ToString();
            jumlah();
        }
        protected void txtSkor3_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp = Convert.ToInt32(txtSkor3.SelectedValue);
            Label3.Text = tmp.ToString();
            Label3n.Text = (tmp * 12.5).ToString(); jumlah();
        }
        protected void txtSkor4_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp = Convert.ToInt32(txtSkor4.SelectedValue);
            Label4.Text = tmp.ToString();
            Label4n.Text = (tmp * 7.5).ToString(); jumlah();
        }
        protected void txtSkor5_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp = Convert.ToInt32(txtSkor5.SelectedValue);
            Label5.Text = tmp.ToString();
            Label5n.Text = (tmp * 12.5).ToString(); jumlah();
        }
        protected void txtSkor6_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp = Convert.ToInt32(txtSkor6.SelectedValue);
            Label6.Text = tmp.ToString();
            Label6n.Text = (tmp * 12.5).ToString(); jumlah();
        }
        protected void txtSkor7_SelectedIndexChanged(object sender, EventArgs e)
        {
            int tmp = Convert.ToInt32(txtSkor7.SelectedValue);
            Label7.Text = tmp.ToString();
            Label7n.Text = (tmp * 12.5).ToString(); jumlah();
        ...
        private void jumlah()
        {
            try
            {
                ...
                try { tmp1 = Convert.ToInt32(Label1n.Text); }
                catch { tmp1 = 0; }
                try { tmp2 = Convert.ToInt32(Label2n.Text); } catch { tmp2 = 0; }
                try { tmp3 = Convert.ToInt32(Label3n.Text); } catch { tmp3 = 0; }
                try { tmp4 = Convert.ToInt32(Label4n.Text); } catch { tmp4 = 0; }
                try { tmp5 = Convert.ToInt32(Label5n.Text); } catch { tmp5 = 0; }
                try { tmp6 = Convert.ToInt32(Label6n.Text); }
                catch { tmp6 = 0; }
                try { tmp7 = Convert.ToInt32(Label7n.Text); }
                catch { tmp7 = 0; }
