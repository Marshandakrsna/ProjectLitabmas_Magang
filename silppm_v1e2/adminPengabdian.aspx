...
AutoEventWireup="true"
    CodeBehind="adminPengabdian.aspx.cs" 
    Inherits="silppm_v1e2.adminPengabdian" %>
    ...
    <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" 
                ...
                <asp:Panel ID="panelBawah" runat="server">
                    <table style="background-color: White; width: 100%;" border="1px" class="GridViewStyle">
                        ...
                        <tr>
                            ...
                            <td class="style12" colspan="2">
                                <asp:TextBox ID="txtJarak" runat="server" Width="83px">0</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style13">
             ...
             <fieldset>
                    ...
                    <table style="background-color: White; width: 100%;" border="1px" class="GridViewStyle">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNppDosen" runat="server" AutoPostBack="True" 
                                    ontextchanged="txtNppDosen_TextChanged"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style15">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblJabatan" runat="server" Text="Tidak Tersedia"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="style15">
        ...
        <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="RAB">
            ...
            <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="CV - Pengalaman Peelitian (5 Tahun Terakhir)">
                <HeaderTemplate>
                    CV - Pengalaman Pengabdian (5 Tahun Terakhir)
                </HeaderTemplate>
            <ContentTemplate>
                <asp:GridView ID="gvCV" runat="server" AutoGenerateColumns="False" 
                    CssClass="GridViewStyle" PageSize="100">
                    <AlternatingRowStyle CssClass="AltRowStyle" />
                    <Columns>
                        <asp:TemplateField HeaderText="No" Visible="False">
                            <ItemTemplate>
                                <asp:Label ID="lbl_no_urut0" runat="server" 
                                    Text="<%# Container.DataItemIndex + 1 %>"></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="grid_header" HorizontalAlign="Left" VerticalAlign="Top" 
                                Width="30px" />
                            <ItemStyle CssClass="grid_cell" Font-Size="Medium" HorizontalAlign="Center" 
                        ...
                        <asp:BoundField DataField="DANA_PRIBADI" DataFormatString="{0:n2}" 
                            HeaderText="Dana Pribadi">
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="DANA_EKSTERNAL" DataFormatString="{0:n2}" 
                            HeaderText="Dana Ekseternal">
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="DANA_KERJASAMA" DataFormatString="{0:n2}" 
                            HeaderText="Dana Kerjasama">
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:BoundField DataField="DANA_UAJY" DataFormatString="{0:n2}" 
                            HeaderText="Dana UAJY">
                        <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                    </Columns>
                    <HeaderStyle CssClass="HeaderStyle" />
