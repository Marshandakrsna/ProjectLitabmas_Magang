    ...
    public partial class WebForm102 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (prop.addfeedback(tmpid, nppProdi, TextBox1.Text, DateTime.Now, RadioButtonList1.Text))
            {
                ...
                if (prop.updateKALPPM(cek, tmpid, sst))
                {
                    ...
                    mail.Subject = "[Pemberitahuan] Proposal anda " + judul + " mendapatkan penolakan dari KALPPM";

                    string Body = @"Maaf " + nama
                        + ",<br/> Proposal anda telah mendapatkan penolakan dari KALPPM &#40;" + namaProdi + "&#41;. <br/> "
                        + "<br/>Judul : " + judul
