<%@ Page Title="" Language="C#" MasterPageFile="~/ReviewerMaster.Master" AutoEventWireup="true" CodeBehind="REVPenelitian.aspx.cs" Inherits="silppm_v1e2.WebForm13" %>
        ...
        <table style="width:100%;" border="1px" class="GridViewStyle">
            ...
            <tr>
                ...
                <td class="style7">
                    ...
                    <asp:DropDownList ID="txtSkor1" runat="server" Height="16px" Width="46px" 
                            onselectedindexchanged="txtSkor1_SelectedIndexChanged" AutoPostBack="true">
            ...
            <tr>
                ...
                <td class="style9">
                    10%</td>
                <td class="style7">
                    <asp:DropDownList ID="txtSkor2" runat="server" Height="16px" Width="46px" 
            ...
            <tr>
                ...
                <td class="style9">
                    10%</td>
                <td class="style7">
                    <asp:DropDownList ID="txtSkor3" runat="server" Height="16px" Width="46px" 
            ...
            <tr>
                ...
                <td class="style9">
                    10%</td>
                <td class="style7">
                    <asp:DropDownList ID="txtSkor4" runat="server" Height="16px" Width="46px" 
            ...
            <tr>
                ...
                <td class="style9">
                    20%</td>
                <td class="style7">
                    <asp:DropDownList ID="txtSkor5" runat="server" Height="16px" Width="46px" 
            ...
            <tr>
                ...
                <td class="style9">
                    10%</td>
                <td class="style7">
                    <asp:DropDownList ID="txtSkor6" runat="server" Height="16px" Width="46px" 
            ...
            <tr>
                ...
                <td class="style9">
                    20%</td>
                <td class="style7">
                    <asp:DropDownList ID="txtSkor7" runat="server" Height="16px" Width="46px" 
