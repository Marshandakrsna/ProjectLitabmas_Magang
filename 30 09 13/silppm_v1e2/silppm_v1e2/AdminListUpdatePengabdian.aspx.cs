...
{
    public partial class WebForm93 : System.Web.UI.Page
    {
        ...
        protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "lihat")
            {
                ...
                dataset.Clear();
                dsTerima.Clear();
                dataset = rev.getProdiDataPerkembanganPengabdian(HiddenField1.Value);
        ...
        {
            Panel1.Visible = false;
            Response.Redirect("AdminListUpdatePengabdian.aspx");
        }
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Lihat")
            {
                ...
                byte[] temp;
                temp = prop.getMONEVPengabdian(HiddenField1.Value, Convert.ToInt32(tmp));
