<%@ Page Title="" Language="C#" MasterPageFile="~/KALPPMmaster.Master" AutoEventWireup="true" CodeBehind="KALPPMApprovalProposal.aspx.cs" Inherits="silppm_v1e2.WebForm55" %>
        ...
        <table style="Background-color:White; width:100%; " border="1px" 
            ...
            <tr>
                <td class="style4" colspan="3">
                    <strong>REVIEW PROPOSAL PENELITIAN INTERNAL </strong>
                </td>
            </tr>
            <tr>
                <td class="style8">
            ...
            <tr>
                <td class="style8">
                    Biaya Direkomendasikan</td>
                <td class="style5" colspan="2">
                    Rp
                    <asp:Label ID="lblDanaRekomen" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style8">
            ...
            <tr>
                ...
                <td class="style5" colspan="2">
                    <asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton2_Click">Lihat Review</asp:LinkButton>
                </td>
            </tr>
            <tr>
