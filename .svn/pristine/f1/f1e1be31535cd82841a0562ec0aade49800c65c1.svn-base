<%@ Page Title="" Language="C#" MasterPageFile="~/Homev3_vertical_menu.Master" AutoEventWireup="true" CodeBehind="KALPPMApprovalPengabdian.aspx.cs" Inherits="silppm_v1e2.WebForm73" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="panelBawah" runat="server">
        ...
        class="GridViewStyle">
            ...
            <tr>
                <td class="style18">
                    Biaya direkomendasi</td>
                <td class="style12" colspan="2">
                    Rp
                    <asp:Label ID="lblBiayaRekomendasi" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style18">
                ...
                <td class="style12" colspan="2">
                    Rp
                    <asp:Label ID="lblBiayaSetuju" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style18">
                    Lihat Hasil Review oleh Assesor</td>
                <td class="style12" colspan="2">
                    <asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton2_Click">Lihat Hasil Review</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td class="style18">
