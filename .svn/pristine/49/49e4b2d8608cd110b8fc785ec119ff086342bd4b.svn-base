<%@ Page Title="" Language="C#" MasterPageFile="~/Homev2.Master" AutoEventWireup="true" CodeBehind="HomePenelitian.aspx.cs" Inherits="silppm_v1e2.HomePenelitian"%>
...
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC5YSG138ljX5BUf8QZx2BiTVNXBpUcfUs&sensor=false">
</script>
        ...
        <table style="Background-color:White; width:100%; " border="1px" 
            ...
            <tr>
                <td colspan="2" style="text-align: center" class="style4">
                    <strong>TAMBAH PROPOSAL PENELITIAN INTERNAL </strong></td>
            </tr>
            <tr>
