...
{
    public partial class adminPengabdian : System.Web.UI.Page
    {
        ...
        protected void getHistPengabdian()
        {
            gvCV.DataSource = abdi.getHstPengabdian(txtNppDosen.Text);
            gvCV.DataBind();
        }
        ...
        private PropPengab setDataPengab() {
            ...
            pengab.Idkaryawan = txtNppDosen.Text;
            ...
            if (dateMulai.Text != "")
                ...
                pengab.Waktu = System.DateTime.Now.Date;
            if (tanggal_selesai.Text != "")
                pengab.Durasi = Convert.ToDateTime(tanggal_selesai.Text);
            else
                pengab.Durasi = System.DateTime.Now.Date;

            pengab.Sasaran = txtSasaran.Text;
            if (ddLRencanaUnit.SelectedValue != "")
