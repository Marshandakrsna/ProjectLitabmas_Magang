<%@ Page Title="" Language="C#" MasterPageFile="~/Homev3_vertical_menu.Master" AutoEventWireup="true" CodeBehind="ProdiApprovalPengabdian.aspx.cs" Inherits="silppm_v1e2.WebForm67" %>
    ...
    <table style="Background-color:White; width:102%; " border="1px" 
        ...
        <tr>
            <td class="style18">
                Biaya Disetujui</td>
            <td class="style12" colspan="2">
                <asp:TextBox ID="txtBiayaSetuju" runat="server" Width="185px"></asp:TextBox>
