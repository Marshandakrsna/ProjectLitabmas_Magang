...
namespace silppm_v1e2
{
    ...
    {
        private string tmpid, tmpRole, nppProdi, nppDekan,nppLppm;
        ...
        {
            if (prop.addfeedback(tmpid,  nppDekan, TextBox1.Text, DateTime.Now, RadioButtonList1.Text))
            {
                int cek = 0;
                int sst;
                ...
                if (prop.updateDekan(cek, tmpid, sst))
                {
                    ...
                    mail.Subject = "[Pemberitahuan] Proposal anda " + judul + " mendapatkan penolakan dari Dekan";

                    string Body = @"Selamat " + nama
                        + ",<br/> Proposal anda telah mendapatkan penolakan dari Dekan &#40;" + namaProdi + "&#41;. <br/>"
                        + "<br/>Judul : " + judul
